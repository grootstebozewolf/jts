 ...
 */
public class CurvedWKTWriterCompoundCurveTest extends GeometryTestCase {

  public static void main(String[] args) {
    TestRunner.run(CurvedWKTWriterCompoundCurveTest.class);
  }

  public CurvedWKTWriterCompoundCurveTest(String name) { super(name); }
  ...
  public void testEmittedWKTContainsTaggedCircularString() throws Exception {
    ...
    Geometry g = new CurvedWKTReader().read(src);
  ...
  public void testRoundTripPreservesMemberStructure() throws Exception {
    ...
    CompoundCurve g = (CompoundCurve) new CurvedWKTReader().read(src);
    ...
    String emitted = new CurvedWKTWriter().write(g);
    CompoundCurve g2 = (CompoundCurve) new CurvedWKTReader().read(emitted);
  ...
  public void testEmittedWKTRoundTripsViaReader() throws Exception {
    ...
    CompoundCurve back = (CompoundCurve) new CurvedWKTReader(f).read(emitted);
  ...
  public void testEmptyCompoundCurveRoundTrip() throws Exception {
    ...
    Geometry back = new CurvedWKTReader(f).read(emitted);
