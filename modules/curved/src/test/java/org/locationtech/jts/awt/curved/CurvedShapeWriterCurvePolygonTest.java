...
/**
 * F-RD: {@link CurvedShapeWriter} must render arc rings of a
 ...
 */
public class CurvedShapeWriterCurvePolygonTest extends GeometryTestCase {

  private static final String ARC_SHELL =
      "CURVEPOLYGON (CIRCULARSTRING (2 0, 0 2, -2 0, 0 -2, 2 0))";

  public static void main(String[] args) {
    TestRunner.run(CurvedShapeWriterCurvePolygonTest.class);
  }

  public CurvedShapeWriterCurvePolygonTest(String name) { super(name); }

  private static SegCounts shapeOf(String wkt) throws Exception {
    Geometry g = new CurvedWKTReader().read(wkt);
    return SegCounts.of(new CurvedShapeWriter().toShape(g));
  }
  ...
  public void testMultiSurfaceRendersCurvedMembers() throws Exception {
