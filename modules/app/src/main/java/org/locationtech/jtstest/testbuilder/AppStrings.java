...
public class AppStrings {
  ...
  static final String TIP_DRAW_COMPOUNDCURVE = "<html>Draw CompoundCurve<br><br>Each triple of points becomes one CircularString member.<br>Add Pt: Left-Click<br>Stream: Left-Drag</html>";
  static final String TIP_DRAW_CURVEPOLYGON = "<html>Draw CurvePolygon<br><br>Closed CircularString shell (no holes).<br>Add Pt: Left-Click<br>Stream: Left-Drag</html>";
