...
public class GeometryLocationsWriter 
{
  ...
  /** Arc label: {@code "Arc R=… "} — we don't compute the exact analytical
   *  radius from the 3 control points here (would need a circumcentre solve);
   *  estimate from the chord and sagitta of the first sub-arc when readily
   *  available, otherwise just emit the type. */
