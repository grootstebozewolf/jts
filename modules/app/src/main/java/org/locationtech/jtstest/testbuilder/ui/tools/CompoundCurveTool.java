 ...
 *
 * <p>The in-progress preview is rendered as circular arcs through every
 * complete (start, mid, end) triple using {@link CircularArcRenderer}.
 */
public class CompoundCurveTool extends AbstractStreamDrawTool {
  ...
  /**
   * Like {@link CircularStringTool#bandFinished()}: a CompoundCurve must have an
   * odd number of points &ge; 3; trailing even-count captures drop the last
   * point.
   */
  @Override
