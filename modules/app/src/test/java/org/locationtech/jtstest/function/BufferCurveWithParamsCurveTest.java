 ...
 * {@link org.locationtech.jts.geom.curve.CircularString}, treating arc
 ...
 */
public class BufferCurveWithParamsCurveTest extends TestCase {

  public static void main(String[] args) { TestRunner.run(suite()); }
  public static Test suite() { return new TestSuite(BufferCurveWithParamsCurveTest.class); }
  public BufferCurveWithParamsCurveTest(String name) { super(name); }
  ...
  public void testArcBufferMatchesDensifiedReference() throws Exception {
    ...
    Geometry referenceLinear =
        ((org.locationtech.jts.geom.curve.Linearizable) densified).toLinear(0.5);
