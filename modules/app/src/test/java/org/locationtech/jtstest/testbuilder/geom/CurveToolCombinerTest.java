 ...
 */
public class CurveToolCombinerTest extends TestCase {

  public static void main(String[] args) { TestRunner.run(CurveToolCombinerTest.class); }
  public CurveToolCombinerTest(String name) { super(name); }
