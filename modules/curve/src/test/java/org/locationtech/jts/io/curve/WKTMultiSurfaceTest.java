...
public class WKTMultiSurfaceTest extends GeometryTestCase {
  ...
  public void testReadEmpty() throws Exception {
    Geometry g = new CurveWKTReader().read("MULTISURFACE EMPTY");
    assertEquals(TYPENAME_MULTISURFACE, g.getGeometryType());
  ...
  public void testWKTRoundTripXY() throws Exception {
    ...
    String emitted2 = new CurveWKTWriter().write(g2);
    assertEquals(emitted, emitted2);
    checkEqual(
        ((org.locationtech.jts.geom.curve.Linearizable) g).toLinear(0),
        ((org.locationtech.jts.geom.curve.Linearizable) g2).toLinear(0));
  }
}
