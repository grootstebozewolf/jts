...
public class WKTCompoundCurveTest extends GeometryTestCase {
  ...
  public void testReadEmpty() throws Exception {
    Geometry g = new CurveWKTReader().read("COMPOUNDCURVE EMPTY");
    assertEquals(TYPENAME_COMPOUNDCURVE, g.getGeometryType());
  ...
  public void testRejectsDisconnectedMembers() throws Exception {
    // positive control
    assertNotNull(new CurveWKTReader().read("COMPOUNDCURVE((0 0, 1 1), (1 1, 2 2))"));

    try {
      new CurveWKTReader().read("COMPOUNDCURVE((0 0, 1 1), (2 2, 3 3))");
