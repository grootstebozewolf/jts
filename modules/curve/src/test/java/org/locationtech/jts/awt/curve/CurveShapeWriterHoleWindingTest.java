 ...
 * defect is the winding rule. {@link CurveShapeWriter} builds its polygon paths
 ...
 * not constrain it and {@code CurveWKTReader} preserves what it is given -- so
 ...
 * {@code CurveShapeWriterCurvePolygonTest} already covers.
 */
public class CurveShapeWriterHoleWindingTest extends GeometryTestCase {
  ...
  public static void main(String[] args) {
    TestRunner.run(CurveShapeWriterHoleWindingTest.class);
  }

  public CurveShapeWriterHoleWindingTest(String name) { super(name); }
