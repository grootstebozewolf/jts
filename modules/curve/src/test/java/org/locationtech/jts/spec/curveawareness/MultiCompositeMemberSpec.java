 ...
 *
 * <p>Run on demand: {@code mvn -pl modules/curve test
...
public class MultiCompositeMemberSpec extends GeometryTestCase {
  ...
  public void test_FMC_READ_membersRetainSubtypes() throws Exception {
    Geometry g = new CurveWKTReader().read(WKT_MC_HETEROGENEOUS);
  ...
  public void test_FMC_COPY_copyPreservesMemberSubtypes() throws Exception {
    MultiCurve mc = (MultiCurve) new CurveWKTReader().read(WKT_MC_HETEROGENEOUS);
  ...
  public void test_FMC_WKT_writerEmitsMemberTagsForRoundTrip() throws Exception {
    MultiCurve mc = (MultiCurve) new CurveWKTReader().read(WKT_MC_HETEROGENEOUS);
    String emitted = new CurveWKTWriter().write(mc);
    ...
    MultiCurve roundTripped = (MultiCurve) new CurveWKTReader().read(emitted);
  ...
  public void test_FMS_READ_membersRetainSubtypes() throws Exception {
    Geometry g = new CurveWKTReader().read(WKT_MS_HETEROGENEOUS);
  ...
  public void test_FMS_COPY_copyPreservesMemberSubtypes() throws Exception {
    MultiSurface ms = (MultiSurface) new CurveWKTReader().read(WKT_MS_HETEROGENEOUS);
  ...
  public void test_FMS_WKT_writerEmitsCurvePolygonTagForRoundTrip() throws Exception {
    MultiSurface ms = (MultiSurface) new CurveWKTReader().read(WKT_MS_HETEROGENEOUS);
    String emitted = new CurveWKTWriter().write(ms);
    ...
    MultiSurface roundTripped = (MultiSurface) new CurveWKTReader().read(emitted);
