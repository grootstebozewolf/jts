...
/**
 * Smoke test that {@link CurveShapeWriter} walks
 ...
 * at junctions).
 */
public class CurveShapeWriterCompoundCurveTest extends GeometryTestCase {

  public static void main(String[] args) {
    TestRunner.run(CurveShapeWriterCompoundCurveTest.class);
  }

  public CurveShapeWriterCompoundCurveTest(String name) { super(name); }
  ...
  public void testLineThenArc() {
    ...
    Shape shape = new CurveShapeWriter().toShape(cc);
