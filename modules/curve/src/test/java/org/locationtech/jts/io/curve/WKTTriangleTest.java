...
public class WKTTriangleTest extends GeometryTestCase {
  ...
  public void testReadXY() throws Exception {
    Geometry g = new CurveWKTReader().read("TRIANGLE((0 0, 1 0, 0 1, 0 0))");
  ...
  public void testReadXYZ() throws Exception {
    Geometry g = new CurveWKTReader().read("TRIANGLE Z((0 0 0, 1 0 0, 0 1 0, 0 0 0))");
    assertEquals(TYPENAME_TRIANGLE, g.getGeometryType());
  ...
  public void testReadXYM() throws Exception {
    Geometry g = new CurveWKTReader().read("TRIANGLE M((0 0 7, 1 0 8, 0 1 9, 0 0 7))");
    assertEquals(TYPENAME_TRIANGLE, g.getGeometryType());
    assertEquals(7.0, g.getCoordinates()[0].getM(), 0.0);
  }

  public void testReadXYZM() throws Exception {
    Geometry g = new CurveWKTReader().read("TRIANGLE ZM((0 0 0 7, 1 0 0 8, 0 1 0 9, 0 0 0 7))");
    assertEquals(TYPENAME_TRIANGLE, g.getGeometryType());
    assertEquals(0.0, g.getCoordinates()[0].getZ(), 0.0);
    assertEquals(7.0, g.getCoordinates()[0].getM(), 0.0);
  }
  ...
  public void testReadEmpty() throws Exception {
    Geometry g = new CurveWKTReader().read("TRIANGLE EMPTY");
    assertEquals(TYPENAME_TRIANGLE, g.getGeometryType());
  ...
  public void testWKTRoundTripXY() throws Exception {
    ...
    Geometry g2 = new CurveWKTReader().read(emitted);
    checkEqual(g, g2);
  }
  ...
  public void testRejectsWrongPointCount() throws Exception {
    // positive control
    assertNotNull(new CurveWKTReader().read("TRIANGLE((0 0, 1 0, 0 1, 0 0))"));

    try {
      new CurveWKTReader().read("TRIANGLE((0 0, 1 0, 1 1, 0 1, 0 0))");
  ...
  public void testRejectsUnclosedRing() throws Exception {
    ...
    try {
      new CurveWKTReader().read("TRIANGLE((0 0, 1 0, 0 1, 0 1))");
  ...
  public void testRejectsInnerRing() throws Exception {
    // positive control
    assertNotNull(new CurveWKTReader().read("TRIANGLE((0 0, 10 0, 0 10, 0 0))"));

    try {
      new CurveWKTReader().read("TRIANGLE((0 0, 10 0, 0 10, 0 0), (1 1, 2 1, 1 2, 1 1))");
