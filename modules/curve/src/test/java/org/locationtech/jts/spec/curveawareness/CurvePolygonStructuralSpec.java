 ...
 * on read (see {@link
 * org.locationtech.jts.io.curve.CurveWKTReader#readCurvePolygonText
 * CurveWKTReader.readCurvePolygonText}), so every assertion below fails.
 */
public class CurvePolygonStructuralSpec extends GeometryTestCase {
  ...
  public void test_FCP_WKT_roundTripPreservesCompoundShell() throws Exception {
    ...
    CurvePolygon roundTripped = (CurvePolygon) new CurveWKTReader().read(emitted);
   ...
   * {@code modules/curve/spec/SPEC_F_CP.md} captures the trade-offs.
   */
