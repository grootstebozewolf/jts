...
are recognised by the curve WKT/WKB pair (WKB 18--21 greenfield).
Clothoid may also appear as a non-leading \texttt{COMPOUNDCURVE}
member.

WKB type codes 8--12 and 18--21 are first-class in core
\texttt{WKBReader} and \texttt{WKBConstants}. Construction still
requires a curve-capable factory; otherwise the reader throws.
\texttt{CurveWKBWriter} emits those codes. A bare
\texttt{WKBWriter} still walks the parent \texttt{instanceof} ladder
for 8--12 and \textbf{refuses} to flatten 18--21. ISO flavour adds
$+1000/+2000/+3000$ for Z/M/ZM.
