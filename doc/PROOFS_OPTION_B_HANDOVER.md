...
| metric | value |
|---|---:|
| B p50 ns (50k calls) | 37172870 |
| densify p50 ns | 140403816 |
| ratio B/ref | 0.26475683538401834 |


## Verdict

B-team seam: straight parity 100%; arc vs densify ≥ 0.99 (A1=0.996151, A2=0.999996); PERF p50 ratio 0.26475683538401834 ≤ 1.15.
