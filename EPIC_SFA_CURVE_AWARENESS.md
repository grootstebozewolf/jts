...
**Status:** Draft v6 MMF Option B (2026-08-17). Tip `c293fe97` · Sync→M.3→R.2→ML.4 **stop** · [LASER_RATCHET.md](doc/LASER_RATCHET.md) · [CHAINSAW_LASER_PROGRAM.md](doc/CHAINSAW_LASER_PROGRAM.md) · [OVERLAYNGCURVE_P2_SEAMS.md](doc/OVERLAYNGCURVE_P2_SEAMS.md).
